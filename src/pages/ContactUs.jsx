...
function ContactUs() {
  return (
    <>
      <div className="max-w-[1300px] mx-auto mt-[100px] lg:px-[80px]">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2 relative">
                    ...
                    <select
                      id="กำหนดราคา"
                      name="กำหนดราคา"
                      className="block appearance-none  w-full h-[50px] pl-[15px] bg-[#F0F0F0] pr-8  rounded-md placeholder:#6A777C text-[#6A777C] focus:outline-none focus:border-blue-500 sm:text-sm"
                    >
      ...
      <div className="mx-w-[1700px] flex flex-wrap mx-auto px-[15px] lg:px-[100px] mt-[100px] mb-[200px]">
        ...
        <div className="w-[100%] lg:w-[25%] bg-[#263676] pt-[60px] pb-[50px] pl-[40px]">
          ...
          <div className="flex mt-3">
            ...
            <p className="text-sm text-white pl-2">
              Clinton_hardware_tools_pump
            </p>
          </div>
          <div className="flex mt-3">
            <img src={facebook} alt="" />
            <p className="text-sm text-white pl-2">
              Clinton Hardware Tools&Pump
            </p>
          </div>
        </div>
      </div>
