...
function ContactUs() {
    return (
        <>
            ...
            <div className="mx-w-[1700px] flex mx-auto px-[100px] mt-[100px] mb-[200px]">
                <div className="w-[50%]">
                    <iframe
                ...
                <div className="w-[25%] bg-[#F3F3F3] pt-[70px] px-[60px]">
                ...
                <div className="w-[25%] bg-[#263676] pt-[60px] pl-[40px]">
